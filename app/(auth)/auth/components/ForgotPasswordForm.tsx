      ...
      {success ? (
        <div className={formStyles.alertSuccess} style={{ textAlign: 'center' }}>
          ...
          <div style={{ marginTop: '1rem' }}>
            <Link href="/auth?mode=login" className={formStyles.link}>Return to log in</Link>
          </div>
        </div>
      ) : (
        <>
          ...
          <div className={formStyles.footer}>
            Remember your password? <Link href="/auth?mode=login" className={formStyles.link}>Log in</Link>
          </div>
        </>
      )}
    </AuthLayout>
